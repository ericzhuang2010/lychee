...
- The manuscript cites the current version-specific Zenodo record as the exclusive supplementary-material location: <https://zenodo.org/records/22436625>.

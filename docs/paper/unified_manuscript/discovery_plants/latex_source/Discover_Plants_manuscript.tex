...
\textbf{Table S1.} Biological-unit registry.

\textbf{Table S2.} Per-library quality control.

\textbf{Table S3.} Genome-wide discovery statistics.

\textbf{Table S4.} Robustness file manifest.

\textbf{Table S5.} All external frozen tests.

\textbf{Table S6.} Pathway and signature tests.

\textbf{Table S7.} Conditional differential-transcript-usage results.

\textbf{Table S8.} Candidate annotation and orthology evidence.

\textbf{Table S9.} Small-RNA reference-gate outcome.

\textbf{Table S10.} Motif-background tests and sensitivity results.

\textbf{Table S11.} Accession-aware evidence registry.

\textbf{Table S12.} Scripts, environments, and command inventory.

\textbf{Table S13.} Protocol amendment and deviation log.

\textbf{Table S14.} Legacy within-cultivar audit.

\textbf{Table S15.} Controlled promoter-motif background comparison.

\textbf{Table S16a.} Reconstructed dataset-search queries.

\textbf{Table S16b.} Dataset eligibility decisions.

\textbf{Table S17.} Exact software versions.

\textbf{Table S18.} Power-simulation minimum detectable effects.

\subsection*{Supplementary figure captions}

\textbf{Figure S1.} Replicate-level normalized counts for the two cross-context-supported genes, twelve Tier B genes, and two legacy highlights. Points are individual deposited libraries; bars show cultivar-treatment medians.

\textbf{Figure S2.} Parametric detection probability for cultivar-by-infection effects under genome-wide discovery and candidate-family external adjustment. Curves show the overall result and mean-expression quartiles; the dashed line marks 80\% power.

\textbf{Figure S3.} Exploratory PRJNA1090613 signed-signature estimate, shown separately because cohort metadata did not support its inclusion in the confirmatory evaluation.
...
The registered protocol, amendment log, analysis source code, Snakemake workflows, configuration files, tests, metadata, and environment specifications are archived under CC BY 4.0 at \url{https://zenodo.org/records/22436625} [46].
...
\item Sun J, Gao Z, Zhang X, Zou X, Cao L, Wang J. Transcriptome analysis of \textit{Phytophthora litchii} reveals pathogenicity arsenals and confirms taxonomic status. PLoS ONE. 2017;12:e0178245. \url{https://doi.org/10.1371/journal.pone.0178245}.

\item Yi C, Jiang Y, Shi J, Qu H, Xue S, Duan X, et al. ATP-regulation of antioxidant properties and phenolics in litchi fruit during browning and pathogen infection process. Food Chemistry. 2010;118:42--47. \url{https://doi.org/10.1016/j.foodchem.2009.04.074}.

\item Hu G, Feng J, Xiang X, Wang J, Saloj\"arvi J, Liu C, et al. Two divergent haplotypes from a highly heterozygous lychee genome suggest independent domestication events for early and late-maturing cultivars. Nature Genetics. 2022;54:73--83. \url{https://doi.org/10.1038/s41588-021-00971-3}.

\item Sun J, Cao L, Li H, Wang G, Wang S, Li F, et al. Early responses given distinct tactics to infection of \textit{Peronophythora litchii} in susceptible and resistant litchi cultivar. Scientific Reports. 2019;9:2810. \url{https://doi.org/10.1038/s41598-019-39100-w}.

\item Liu H, Yan Q, Jiang Y, Shi F, Chen J, Cai C, et al. Identification of LcCDPKs and analysis of their expression patterns in response to downy mildew stresses in lychee. Journal of Fruit Science. 2023;40:442--456. \url{https://doi.org/10.13925/j.cnki.gsxb.20220307}.

\item Li P, Li W, Zhou X, Situ J, Xie L, Xi P, et al. \textit{Peronophythora litchii} RXLR effector PlAvh202 destabilizes a host ethylene biosynthesis enzyme. Plant Physiology. 2023;193:756--774. \url{https://doi.org/10.1093/plphys/kiad311}.
...
\item Berka M, Kopeck\'a R, Berkov\'a V, Brzobohat\'y B, \v{C}ern\'y M. Regulation of heat shock proteins 70 and their role in plant immunity. Journal of Experimental Botany. 2022;73:1894--1909. \url{https://doi.org/10.1093/jxb/erab549}.

\item Andrews S. FastQC: a quality control tool for high throughput sequence data. Babraham Bioinformatics; 2010.

\item Bolger AM, Lohse M, Usadel B. Trimmomatic: a flexible trimmer for Illumina sequence data. Bioinformatics. 2014;30:2114--2120. \url{https://doi.org/10.1093/bioinformatics/btu170}.

\item Kim D, Pertea G, Trapnell C, Pimentel H, Kelley R, Salzberg SL. TopHat2: accurate alignment of transcriptomes in the presence of insertions, deletions and gene fusions. Genome Biology. 2013;14:R36. \url{https://doi.org/10.1186/gb-2013-14-4-r36}.

\item Anders S, Pyl PT, Huber W. HTSeq---a Python framework to work with high-throughput sequencing data. Bioinformatics. 2015;31:166--169. \url{https://doi.org/10.1093/bioinformatics/btu638}.
...
\item Love MI, Huber W, Anders S. Moderated estimation of fold change and dispersion for RNA-seq data with DESeq2. Genome Biology. 2014;15:550. \url{https://doi.org/10.1186/s13059-014-0550-8}.

\item Chen C, Chen H, Zhang Y, Thomas HR, Frank MH, He Y, et al. TBtools: an integrative toolkit developed for interactive analyses of big biological data. Molecular Plant. 2020;13:1194--1202. \url{https://doi.org/10.1016/j.molp.2020.06.009}.
...
\item Lescot M, D\'ehais P, Thijs G, Marchal K, Moreau Y, Van de Peer Y, et al. PlantCARE, a database of plant cis-acting regulatory elements and a portal to tools for in silico analysis of promoter sequences. Nucleic Acids Research. 2002;30:325--327. \url{https://doi.org/10.1093/nar/30.1.325}.
...
\item Chen S, Zhou Y, Chen Y, Gu J. fastp: an ultra-fast all-in-one FASTQ preprocessor. Bioinformatics. 2018;34:i884--i890. \url{https://doi.org/10.1093/bioinformatics/bty560}.

\item Dobin A, Davis CA, Schlesinger F, Drenkow J, Zaleski C, Jha S, et al. STAR: ultrafast universal RNA-seq aligner. Bioinformatics. 2013;29:15--21. \url{https://doi.org/10.1093/bioinformatics/bts635}.

\item Liao Y, Smyth GK, Shi W. featureCounts: an efficient general purpose program for assigning sequence reads to genomic features. Bioinformatics. 2014;30:923--930. \url{https://doi.org/10.1093/bioinformatics/btt656}.

\item Patro R, Duggal G, Love MI, Irizarry RA, Kingsford C. Salmon provides fast and bias-aware quantification of transcript expression. Nature Methods. 2017;14:417--419. \url{https://doi.org/10.1038/nmeth.4197}.

\item Pockrandt C, Alzamel M, Iliopoulos CS, Reinert K. GenMap: ultra-fast computation of genome mappability. Bioinformatics. 2020;36:3687--3692. \url{https://doi.org/10.1093/bioinformatics/btaa222}.

\item Zhu A, Ibrahim JG, Love MI. Heavy-tailed prior distributions for sequence count data: removing the noise and preserving large differences. Bioinformatics. 2019;35:2084--2092. \url{https://doi.org/10.1093/bioinformatics/bty895}.

\item Naithani S, Gupta P, Preece J, D'Eustachio P, Elser J, Garg P, et al. Plant Reactome knowledgebase: empowering plant pathway exploration and OMICS data analysis. Nucleic Acids Research. 2024;52:D1538--D1547. \url{https://doi.org/10.1093/nar/gkad1052}.

\item Buchfink B, Xie C, Huson DH. Fast and sensitive protein alignment using DIAMOND. Nature Methods. 2015;12:59--60. \url{https://doi.org/10.1038/nmeth.3176}.

\item Wu D, Smyth GK. Camera: a competitive gene set test accounting for inter-gene correlation. Nucleic Acids Research. 2012;40:e133. \url{https://doi.org/10.1093/nar/gks461}.

\item Wu D, Lim E, Vaillant F, Asselin-Labat ML, Visvader JE, Smyth GK. ROAST: rotation gene set tests for complex microarray experiments. Bioinformatics. 2010;26:2176--2182. \url{https://doi.org/10.1093/bioinformatics/btq401}.

\item Korotkevich G, Sukhov V, Budin N, Shpak B, Artyomov MN, Sergushichev A. Fast gene set enrichment analysis. bioRxiv. 2021:060012. \url{https://doi.org/10.1101/060012}.

\item Nowicka M, Robinson MD. DRIMSeq: a Dirichlet-multinomial framework for multivariate count outcomes in genomics. F1000Research. 2016;5:1356. \url{https://doi.org/10.12688/f1000research.8900.2}.

\item Anders S, Reyes A, Huber W. Detecting differential usage of exons from RNA-seq data. Genome Research. 2012;22:2008--2017. \url{https://doi.org/10.1101/gr.133744.111}.

\item Van den Berge K, Soneson C, Robinson MD, Clement L. stageR: a general stage-wise method for controlling the gene-level false discovery rate in differential expression and differential transcript usage. Genome Biology. 2017;18:151. \url{https://doi.org/10.1186/s13059-017-1277-0}.

\item Robinson MD, McCarthy DJ, Smyth GK. edgeR: a Bioconductor package for differential expression analysis of digital gene expression data. Bioinformatics. 2010;26:139--140. \url{https://doi.org/10.1093/bioinformatics/btp616}.

\item The UniProt Consortium. UniProt: the Universal Protein Knowledgebase in 2023. Nucleic Acids Research. 2023;51:D523--D531. \url{https://doi.org/10.1093/nar/gkac1052}.

\item Jones P, Binns D, Chang HY, Fraser M, Li W, McAnulla C, et al. InterProScan 5: genome-scale protein function classification. Bioinformatics. 2014;30:1236--1240. \url{https://doi.org/10.1093/bioinformatics/btu031}.

\item Rauluseviciute I, Riudavets-Puig R, Blanc-Mathieu R, Castro-Mondragon JA, Ferenc K, Kumar V, et al. JASPAR 2024: 20th anniversary of the open-access database of transcription factor binding profiles. Nucleic Acids Research. 2024;52:D174--D182. \url{https://doi.org/10.1093/nar/gkad1059}.

\item McLeay RC, Bailey TL. Motif enrichment analysis: a unified framework and an evaluation on ChIP data. BMC Bioinformatics. 2010;11:165. \url{https://doi.org/10.1186/1471-2105-11-165}.

\item Grant CE, Bailey TL, Noble WS. FIMO: scanning for occurrences of a given motif. Bioinformatics. 2011;27:1017--1018. \url{https://doi.org/10.1093/bioinformatics/btr064}.

\item Guo Z, Kuang Z, Wang Y, Zhao Y, Tao Y, Cheng C, et al. PmiREN: a comprehensive encyclopedia of plant miRNAs. Nucleic Acids Research. 2020;48:D1114--D1121. \url{https://doi.org/10.1093/nar/gkz894}.

\item M\"older F, Jablonski KP, Letcher B, Hall MB, Tomkins-Tinch CH, Sochat V, et al. Sustainable data analysis with Snakemake. F1000Research. 2021;10:33. \url{https://doi.org/10.12688/f1000research.29032.2}.

\item National Center for Biotechnology Information. BioProject accession PRJNA450886. \url{https://www.ncbi.nlm.nih.gov/bioproject/PRJNA450886}.

\item National Center for Biotechnology Information. GEO accession GSE222651. \url{https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE222651}.

\item National Center for Biotechnology Information. GEO accession GSE222650. \url{https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE222650}.

\item National Center for Biotechnology Information. GEO accession GSE262200. \url{https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE262200}.

\item Zhuang E. Supplemental material for ``Cultivar-dependent transcriptional responses of lychee to \textit{Peronophythora litchii}: a registered genome-wide analysis.'' Zenodo. 2026. \url{https://zenodo.org/records/22436625}.
\end{enumerate}
